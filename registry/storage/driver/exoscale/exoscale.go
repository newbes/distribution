...
import (
	...
	"github.com/newbes/aws"
	"github.com/newbes/s3"
...
func init() {
	factory.Register(driverName, &exoscaleDriverFactory{})
}

// exoscaleDriverFactory implements the factory.StorageDriverFactory interface
type exoscaleDriverFactory struct{}

func (factory *exoscaleDriverFactory) Create(parameters map[string]interface{}) (storagedriver.StorageDriver, error) {
